...
**Version 1.4.1:** unlimited SQLite history, search, disk usage, configurable retention, raw/current-format copying, and an ASCII interface with a floating metal clip. Run the new installer to update while keeping your settings and history.
